...
Wells=wf.wellfunc(Location='Cedar Valley')
...
Wells.well_plot(origwelldata_df, well_df, plot_wells=Plot)  # plot the data to look at
...
gldas_df, names =Wells.get_sat_data(new=New, PDSI=True, SoilMoist=True, Temp=False, Precip=False)


# plot the external input data
#Data Plotter not working again....
Wells.plot_sat_data(gldas_df, plot_data=Plot)
